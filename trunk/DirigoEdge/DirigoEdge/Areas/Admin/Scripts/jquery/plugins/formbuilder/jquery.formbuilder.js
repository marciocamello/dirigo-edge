...
(function () {
    Formbuilder.registerField('image', {
        order: 1,
        view: "<input type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' /><a href='#'>Select Image...</a>",
        edit: "",
...
(function () {
    Formbuilder.registerField('wysiwyg', {
        order: 3,
        view: "<textarea class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>'></textarea>",
        edit: "",
        addButton: "<span class='symbol'><span class='fa fa-pencil'></span></span>  WYSIWYG"
    });
...
this["Formbuilder"]["templates"]["view/duplicate_remove"] = function (obj) {
    ...
    with (obj) {
        ...
        ((__t = (Formbuilder.options.BUTTON_CLASS)) == null ? '' : __t) +
        '" title="Duplicate Field">Duplicate <i class=\'fa fa-copy\'></i></a>\n  <a class="js-clear ' +
        ((__t = (Formbuilder.options.BUTTON_CLASS)) == null ? '' : __t) +
        '" title="Remove Field">Remove <i class=\'fa fa-minus-circle\'></i></a>\n</div>';
